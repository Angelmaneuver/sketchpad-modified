	...
	<main id="articles">
		...
		<?php else : ?>
			<article <?php post_class(); ?>>
				<header>
					<h3 class="post-title"><?php esc_html_e( 'Sorry, no results for your search request...', 'sketchpad-modified' ); ?></h3>
				</header>
				<p><?php esc_html_e( 'Try to search again', 'sketchpad-modified' ); ?></p>
